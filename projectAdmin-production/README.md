# TrainMICE Admin Dashboard

Production-ready admin dashboard for TrainMICE platform built with React, TypeScript, Vite, and Tailwind CSS.

## 🚀 Features

- ✅ **Production-Ready**: Optimized build configuration for Vercel
- ✅ **Type-Safe**: Full TypeScript support with strict mode
- ✅ **Modern Stack**: React 18, Vite 7, Tailwind CSS
