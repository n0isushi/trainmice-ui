# TrainMICE Trainer Portal

Production-ready trainer-facing web application for TrainMICE platform built with React, TypeScript, Vite, and Tailwind CSS.
